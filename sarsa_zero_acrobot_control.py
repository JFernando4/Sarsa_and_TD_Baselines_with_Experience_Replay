...
# Environment
from Experiment_Engine import Acrobot
...
class ExperimentAgent():
    def __init__(self, experiment_parameters):
        ...
        self.config.obs_dims = [4]              # Dimensions of the observations as experienced by the agent
        ...
        self.config.env_state_dims = [4]        # Dimensions of the raw environment's states
        ...
        " Environment "
        self.env = Acrobot(config=self.config, summary=self.summary)
...
if __name__ == "__main__":
    ...
    results_directory = os.path.join(working_directory, "Results", "Acrobot_Control")
