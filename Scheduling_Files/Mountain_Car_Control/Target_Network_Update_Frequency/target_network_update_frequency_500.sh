...
do
    ...
    -name Target_Network_Results/Target_Network_Update_Freq500/agent_$i \
    -quiet -tnetwork_update_freq 500 -alpha 0.00025 -onpolicy -hidden_units 800 -max_steps 1000
done